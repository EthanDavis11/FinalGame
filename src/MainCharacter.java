...
public class MainCharacter extends Character {
    ...
    public MainCharacter(int h, int d, int l, int s, int x, int y,Animation i,Animation rr,Animation rl,Animation j,Animation f,Boolean g, Boolean jm) {
        super(h, d, l, s, x, y,i,rr,rl,j,f,g,jm);
